...
ALTER TABLE Menu ADD FOREIGN KEY (recipe_id)
...
ALTER TABLE Recipes ADD FOREIGN KEY (product_id, id)
  REFERENCES RecipeProducts(product_id, recipe_id) ON DELETE NO ACTION ON UPDATE CASCADE DEFERRABLE;

ALTER TABLE Products ADD FOREIGN KEY (id, recipe_id)
  REFERENCES RecipeProducts(product_id, recipe_id) ON DELETE NO ACTION ON UPDATE CASCADE DEFERRABLE;
...
ALTER TABLE Orders ADD FOREIGN KEY (id, item_id)
  REFERENCES OrderItems (order_id, item_id) ON DELETE NO ACTION ON UPDATE CASCADE DEFERRABLE;
